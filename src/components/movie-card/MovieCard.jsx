                ...
                cards.push(
                    <Card key={movie.id} className="mobile movieCard" style={cardStyle} bodyStyle={cardBodyStyle} hoverable>
                        <Flex className="movieCard__wrapper" vertical>
                            ...
                            <Rate rootClassName="movieCard__rate" count={10} defaultValue={movie.myRate} onChange={(newRating) => appValue.addRatingForMovie(movie.id, newRating)} allowHalf />
                        </Flex>
                    </Card>
                );
            });
                        ...
                        <Flex className="movieCard__wrapper" vertical>
                            <Flex className="movieCard__poster">
                                ...
                                <Flex className="movieCard__movieInfo" vertical>
                                    ...
                                    <Rate className="movieCard__movieInfo-rate" count={10} defaultValue={movie.myRate} onChange={(newRating) => appValue.addRatingForMovie(movie.id, newRating)} allowHalf />
                                </Flex>
                            </Flex>
                        </Flex>
                    </Card>
